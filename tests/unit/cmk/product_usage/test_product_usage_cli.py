...
import cmk.product_usage.cmk_product_usage_cli
...
def test_load_product_usage_config_with_missing_http_proxies(
    ...
    monkeypatch.setattr("cmk.product_usage.cmk_product_usage_cli.load", mock_load)
    monkeypatch.setattr("cmk.product_usage.cmk_product_usage_cli.make_app", MagicMock())
    ...
    config = cmk.product_usage.cmk_product_usage_cli.load_config(logger=mock.Mock())
