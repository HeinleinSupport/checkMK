...
from cmk.legacy_checks.ups_cps_inphase import discover_ups_cps_inphase, parse_ups_cps_inphase
from cmk.legacy_includes.elphase import check_elphase as check_ups_cps_inphase
