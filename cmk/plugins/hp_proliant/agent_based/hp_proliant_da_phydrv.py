...
snmp_section_hp_proliant_da_phydrv = SimpleSNMPSection(
...
def check_hp_proliant_da_phydrv(item: str, section: Section) -> CheckResult:
...
check_plugin_hp_proliant_da_phydrv = CheckPlugin(
    name="hp_proliant_da_phydrv",
