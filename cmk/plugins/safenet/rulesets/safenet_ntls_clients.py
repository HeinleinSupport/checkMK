...
def _parameter_ruleset_safenet_ntls_clients() -> Dictionary:
    return Dictionary(
        elements={
            "levels": DictElement(
                parameter_form=Levels(
                    title=Title("NTLS Clients"),
...
rule_spec_safenet_ntls_clients = CheckParameters(
    ...
    parameter_form=_parameter_ruleset_safenet_ntls_clients,
    title=Title("Safenet NTLS Clients"),
