...
def get_default_addresses(werk: WerkV3) -> list[Address]:
    addresses = []
...
def build_mail_addresses(werk: WerkV3, args: Args) -> Sequence[Address]:
...
def load_werk_fixup(werk_commit: WerkCommit, change: WerkChange, repo: Repo, args: Args) -> WerkV3:
    try:
